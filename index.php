			...
			<div class="intro__content">
				...
				<div class="intro__title">
					...
					<div class="intro-description__wrapper">
						<p>
							Каждый день ваш сын будет Фокусироваться на каком то элементе психологии вратаря и внедрять новую привычку в свою игру
						</p>
					</div>
	...
	<section class="s3" >
		<div class="_container">
			<div class="s3__content">
				<div class="s3__info">
					<div class="s3__title">
						<h4>На протяжении 5 дней</h4>
					</div>
					<div class="s3__text">
						<p>
							Ваш ребенок будет Фокусироваться на каком то элементе 
